...
!(function () {
        ...
        (Awesomplete.count = (Awesomplete.count || 0) + 1),
            ...
            (this._events = {
                input: {
                    ...
                    keydown: function (t) {
                        var e = t.keyCode;
                        s.opened && (13 === e && s.selected ? (t.preventDefault(), s.select()) : 27 === e ? s.close({ reason: "esc" }) : (38 !== e && 40 !== e) || (t.preventDefault(), s[38 === e ? "previous" : "next"]()));
                    },
                },
    ...
    (r.prototype = {
        ...
        close: function (t) {
            this.opened && (this.ul.setAttribute("hidden", ""), (this.isOpened = !1), (this.index = -1), this.status.setAttribute("hidden", ""), i.fire(this.input, "awesomplete-close", t || {}));
        },
        open: function () {
            this.ul.removeAttribute("hidden"), (this.isOpened = !0), this.status.removeAttribute("hidden"), this.autoFirst && -1 === this.index && this.goto(0), i.fire(this.input, "awesomplete-open");
        },
        destroy: function () {
        ...
        select: function (t, e) {
            if ((t ? (this.index = i.siblingIndex(t)) : (t = this.ul.children[this.index]), t)) {
                ...
                i.fire(this.input, "awesomplete-select", { text: n, origin: e || t }) && (this.replace(n), this.close({ reason: "select" }), i.fire(this.input, "awesomplete-selectcomplete", { text: n }));
            }
        },
        evaluate: function () {
            var e = this,
            ...
            i.length >= this.minChars && this._list.length > 0
                ? ((this.index = -1),
                  ...
                  0 === this.ul.children.length ? ((this.status.textContent = "No results found"), this.close({ reason: "nomatches" })) : (this.open(), (this.status.textContent = this.ul.children.length + " results found")))
