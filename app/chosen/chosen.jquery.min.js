                        ...
                        ((r = l[i]).search_match = !1),
                            ...
                            this.include_option_in_results(r) &&
                                ...
                                (r.group && !this.group_search) ||
                                    ...
                                    r.search_match ? (h.length && ((d = u.index), (o = f.slice(0, d)), (s = f.slice(d, d + h.length)), (p = f.slice(d + h.length)), (r.highlighted_html = this.escape_html(o) + "<em>" + this.escape_html(s) + "</em>" + this.escape_html(p))), null != a && (a.group_match = !0)) : null != r.group_array_index && this.results_data[r.group_array_index].search_match && (r.search_match = !0)));
                        ...
                        return (
                            ...
                            this.is_multiple && this.max_selected_options <= this.choices_count()
                                ...
                                : (this.is_multiple ? e.removeClass("active-result") : this.reset_single_select_options(),
                                  ...
                                  this.is_multiple && (!this.hide_results_on_select || t.metaKey || t.ctrlKey) ? (t.metaKey || t.ctrlKey ? this.winnow_results({ skip_highlight: !0 }) : (this.search_field.val(""), this.winnow_results())) : (this.results_hide(), this.show_search_field_default()),
