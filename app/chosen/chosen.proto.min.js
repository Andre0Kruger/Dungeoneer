        ...
        (e = (function () {
            ...
            return (
                ...
                (e.prototype.results_option_build = function (e) {
                    var t, s, i, r, n, o, l;
                    for (t = "", l = 0, r = 0, n = (o = this.results_data).length; r < n && ((s = o[r]), (i = ""), "" !== (i = s.group ? this.result_add_group(s) : this.result_add_option(s)) && (l++, (t += i)), (null != e ? e.first : void 0) && (s.selected && this.is_multiple ? this.choice_build(s) : s.selected && !this.is_multiple && this.single_set_selected_text(this.choice_label(s))), !(l >= this.max_shown_results)); r++);
                    return t;
                }),
                ...
                (e.prototype.result_add_group = function (e) {
                    var t, s;
                    return (e.search_match || e.group_match) && e.active_options > 0 ? ((t = []).push("group-result"), e.classes && t.push(e.classes), (s = document.createElement("li")), (s.className = t.join(" ")), (s.innerHTML = e.highlighted_html || this.escape_html(e.label)), e.title && (s.title = e.title), this.outerHTML(s)) : "";
                }),
                        ...
                        ((n = h[i]).search_match = !1),
                            ...
                            this.include_option_in_results(n) &&
                                ...
                                (n.group && !this.group_search) ||
                                    ...
                                    n.search_match ? (l.length && ((d = u.index), (o = f.slice(0, d)), (s = f.slice(d, d + l.length)), (p = f.slice(d + l.length)), (n.highlighted_html = this.escape_html(o) + "<em>" + this.escape_html(s) + "</em>" + this.escape_html(p))), null != _ && (_.group_match = !0)) : null != n.group_array_index && this.results_data[n.group_array_index].search_match && (n.search_match = !0)));
                    return this.result_clear_highlight(), a < 1 && l.length ? (this.update_results_content(""), this.no_results(l)) : (this.update_results_content(this.results_option_build()), (null != e ? e.skip_highlight : void 0) ? void 0 : this.winnow_results_set_highlight());
                }),
            ...
            return (
                ...
                (r.prototype.set_up_html = function () {
                    ...
                    return (
                        ...
                        this.is_multiple ? ((this.search_choices = this.container.down("ul.chosen-choices")), (this.search_container = this.container.down("li.search-field"))) : ((this.search_container = this.container.down("div.chosen-search")), (this.selected_item = this.container.down(".chosen-single"))),
                        this.results_build(),
                        this.set_tab_index(),
                ...
                (r.prototype.destroy = function () {
                    var e, t, s, i;
                    for (this.container.ownerDocument.stopObserving("click", this.click_test_action), t = 0, s = (i = ["chosen:updated", "chosen:activate", "chosen:open", "chosen:close"]).length; t < s; t++) (e = i[t]), this.form_field.stopObserving(e);
                    return (
                ...
                (r.prototype.container_mousedown = function (e) {
                    ...
                    if (!this.is_disabled)
                        return (
                            ...
                            null != e && e.target.hasClassName("search-choice-close") ? void 0 : (this.active_field ? this.is_multiple || !e || (e.target !== this.selected_item && !e.target.up("a.chosen-single")) || this.results_toggle() : (this.is_multiple && this.search_field.clear(), this.container.ownerDocument.observe("click", this.click_test_action), this.results_show()), this.activate_field())
                        );
                }),
                ...
                (r.prototype.results_build = function () {
                    return (
                        ...
                        this.is_multiple ? this.search_choices.select("li.search-choice").invoke("remove") : (this.single_set_selected_text(), this.disable_search || this.form_field.options.length <= this.disable_search_threshold ? ((this.search_field.readOnly = !0), this.container.addClassName("chosen-container-single-nosearch")) : ((this.search_field.readOnly = !1), this.container.removeClassName("chosen-container-single-nosearch"))),
                ...
                (r.prototype.result_do_highlight = function (e) {
                    var t, s, i, r, n;
                    return this.result_clear_highlight(), (this.result_highlight = e), this.result_highlight.addClassName("highlighted"), (i = parseInt(this.search_results.getStyle("maxHeight"), 10)), (n = this.search_results.scrollTop), (r = i + n), (s = this.result_highlight.positionedOffset().top), (t = s + this.result_highlight.getHeight()) >= r ? (this.search_results.scrollTop = t - i > 0 ? t - i : 0) : s < n ? (this.search_results.scrollTop = s) : void 0;
                }),
                ...
                (r.prototype.set_label_behavior = function () {
                    if (((this.form_field_label = this.form_field.up("label")), null == this.form_field_label && (this.form_field_label = $$("label[for='" + this.form_field.id + "']").first()), null != this.form_field_label)) return this.form_field_label.observe("click", this.label_click_handler);
                }),
                ...
                (r.prototype.choice_destroy = function (e) {
                    if (this.result_deselect(e.readAttribute("rel"))) return this.active_field ? this.search_field.focus() : this.show_search_field_default(), this.is_multiple && this.choices_count() > 0 && this.get_search_field_value().length < 1 && this.results_hide(), e.up("li").remove(), this.search_field_scale();
                }),
                        ...
                        return (
                            ...
                            this.is_multiple && this.max_selected_options <= this.choices_count()
                                ...
                                : (this.is_multiple ? t.removeClassName("active-result") : this.reset_single_select_options(),
                                  ...
                                  this.is_multiple && (!this.hide_results_on_select || e.metaKey || e.ctrlKey) ? (e.metaKey || e.ctrlKey ? this.winnow_results({ skip_highlight: !0 }) : ((this.search_field.value = ""), this.winnow_results())) : (this.results_hide(), this.show_search_field_default()),
                ...
                (r.prototype.single_set_selected_text = function (e) {
                    return null == e && (e = this.default_text), e === this.default_text ? this.selected_item.addClassName("chosen-default") : (this.single_deselect_control_build(), this.selected_item.removeClassName("chosen-default")), this.selected_item.down("span").update(e);
                }),
                (r.prototype.result_deselect = function (e) {
                    var t;
                    return (t = this.results_data[e]), !this.form_field.options[t.options_index].disabled && ((t.selected = !1), (this.form_field.options[t.options_index].selected = !1), (this.selected_option_count = null), this.result_clear_highlight(), this.results_showing && this.winnow_results(), this.trigger_form_field_change(), this.search_field_scale(), !0);
                }),
                ...
                (r.prototype.keyup_arrow = function () {
                    var e, t, s;
                    return this.results_showing || this.is_multiple ? (this.result_highlight ? ((s = this.result_highlight.previousSiblings()), (e = this.search_results.select("li.active-result")), (t = s.intersect(e)).length ? this.result_do_highlight(t.first()) : (this.choices_count() > 0 && this.results_hide(), this.result_clear_highlight())) : void 0) : this.results_show();
                }),
                (r.prototype.keydown_backstroke = function () {
                    ...
                    return this.pending_backstroke
                        ...
                        : (e = this.search_container.siblings().last()) && e.hasClassName("search-choice") && !e.hasClassName("search-choice-disabled")
                          ? ((this.pending_backstroke = e), this.pending_backstroke && this.pending_backstroke.addClassName("search-choice-focus"), this.single_backstroke_delete ? this.keydown_backstroke() : this.pending_backstroke.addClassName("search-choice-focus"))
                          : void 0;
                }),
                ...
                (r.prototype.search_field_scale = function () {
                    ...
                    if (this.is_multiple) {
                        ...
                        return (t = new Element("div").update(this.escape_html(this.get_search_field_value()))).setStyle(n), document.body.appendChild(t), (l = t.measure("width") + 25), t.remove(), (e = this.container.getWidth()) && (l = Math.min(e - 10, l)), this.search_field.setStyle({ width: l + "px" });
                    }
                }),
