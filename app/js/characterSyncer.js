//* Esse arquivo parece ser usado na parte de servidor, pra sincronizar os personagens entre os jogadores
    ...
    constructor(url, plaqueEle, importer) {
        ...
        function refresh() {
            ...
            cls.importer.getCharacter(cls.url, (charData) => {
                ...
                if (syncerContainer) syncerContainer.parentNode.removeChild(syncerContainer);
                ...
                if (charData.insight) syncerContainer.appendChild(cls.createLabeledNote("Insight: ", charData.insight));
