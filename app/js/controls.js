// Esse arquivo serve pra fazer as chamadas IPCRenderer
...
document.addEventListener("DOMContentLoaded", function () {
	...
	if (closeAppButton)
		closeAppButton.onclick = function (evt) {
			ipcRenderer.send("close-app");
		};
	if (closeWindowButton)
		closeWindowButton.onclick = function (evt) {
	...
	contextMenus.forEach((menu) => {
		menu.addEventListener("mouseenter", (e) => {
			...
			[...document.querySelectorAll(".context_menu")].forEach((x) =>
